...
const ImageComponent = () => {
  ...
  return (
    <div id="editor" style={{ position: "sticky", top: 0, overflow: "hidden", height: "100vh", maxHeight: "100vh" }} className="sm:w-1/2 w-screen sm:h-screen h-[30rem] flex justify-center items-center bg-gray-400">
     <canvas
